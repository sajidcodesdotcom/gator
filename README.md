...
```bash
go install github.com/sajidcodesdotcom/gator@latest
```
...
There are a few other commands you'll you can use as well:

- `gator login <name>` - Log in as a user that already exists, in the db
